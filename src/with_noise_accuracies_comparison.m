...
plot(Ccc,noisepinplot,'b',Ccc(ind),maxvalue,'ob');
hold on 
%Finding peak
[maxvalue1, ind1] = max(noisesvmplot);
plot(Ccc,noisesvmplot,'m',Ccc(ind1),maxvalue1,'om');
hold on 
%Finding peak
...
legend('Linear SVM with noise',strcat(num2str(maxvalue),',',num2str(Ccc(ind))),'Improved algorithm with noise',strcat(num2str(maxvalue1),',',num2str(Ccc(ind1))),'TSVM with noise',strcat(num2str(maxvalue2),',',num2str(Ccc(ind2))));
