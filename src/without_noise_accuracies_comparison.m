...
plot(Ccc,noisepinplot,'m',Ccc(ind),maxvalue,'om');
hold on 
%Finding peak
...
legend('Improved algorithm without noise',strcat(num2str(maxvalue),',',num2str(Ccc(ind))),'Linear SVM without noise',strcat(num2str(maxvalue1),',',num2str(Ccc(ind1))),'TSVM without noise',strcat(num2str(maxvalue2),',',num2str(Ccc(ind2))));
